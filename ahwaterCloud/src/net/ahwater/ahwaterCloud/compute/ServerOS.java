...
public class ServerOS {
	 ...
	 * @return
	 */
	public static List<? extends Server> listAllServersDetail(OSClientV2 os){
	 ...
	 * @return
	 */
	public static List<? extends Server> listAllServersBrief(OSClientV2 os){
	 ...
	 * @return
	 */
	public static List<? extends Server>listAllTenantServes(OSClientV2 os){
	 ...
	 * @return
	 */
	public static Server getServerById(OSClientV2 os,String serverId){
	 ...
	 * @throws IOException
	 */
	public static String listActionsForServer(String tenantId,String tokenId,String serverId) throws IOException{
	 ...
	 * @return
	 */
	public static List<? extends Keypair> listAllKeypair(OSClientV2 os){
	 ...
	 * @return
	 */
	public static List<? extends SecGroupExtension> listSecurityGroups(OSClientV2 os){
