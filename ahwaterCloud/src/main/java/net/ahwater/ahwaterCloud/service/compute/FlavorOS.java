...
public class FlavorOS {
     ...
     * @return
     */
    public Flavor getFlavorById(OSClientV2 os, String flavorId) {
    ...
    public List<? extends Flavor> listPublicAndNonpublicFlavors(OSClientV2 os) {
     ...
     * @return
     */
    public List<TenantListEle> listAllTenant(OSClientV2 os) {
