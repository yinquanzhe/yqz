package net.ahwater.ahwaterCloud.service.tenant;
...
public class TenantOS {
     ...
     * @return
     */
    public List<? extends Tenant> ListAllTenant(OSClientV2 os) {
    ...
    public String editTenant(OSClientV2 os, String newName, String newDescription) {
        String exceptionMessage;
        try {
            Tenant t = tenant.toBuilder().name(newName).description(newDescription).build();
