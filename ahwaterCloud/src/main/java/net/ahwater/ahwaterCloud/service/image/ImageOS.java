package net.ahwater.ahwaterCloud.service.image;

import net.ahwater.ahwaterCloud.entity.image.ImageName;
...
//				);
     ...
     * @return
     */
    public List<? extends Image> queryAllImages(OSClientV2 os) {
     ...
     *列出租户拥有的image
     */
    public List<? extends Image> queryOwnedImage(OSClientV2 os, String tenantId) {
        List<? extends Image> images = os.images().list();
     ...
     * @return
     */
    public List<? extends Image> queryPublicImage(OSClientV2 os) {
        List<? extends Image> images = os.images().list();
...
//		String strURL = "http://ahwater-cloud-controller:9292/v2/images/b0e064d5-e443-49b7-bd4b-4c18b50f2ba5";
        ...
        String param = "[" + JsonUtils.toJson(name) + "]";
        String result = null;
        ...
        //}
        try {
            result = HttpUtils.patch(strURL, tokenId, param);
        } catch (Exception e) {
            e.printStackTrace();
        }
