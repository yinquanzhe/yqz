package net.ahwater.ahwaterCloud.service.summary;
...
public class QuotaOs {
     ...
     * @throws IOException
     */
    public QuotaEntity GetTenantQuota(OSClientV2 os, String tenantId) {
     ...
     * @param limit
     */
    public void UpdateTenantQuota(OSClientV2 os, String tenantId, QuotaEntity limit) {
        os.perspective(Facing.ADMIN);
     ...
     * @throws IOException
     */
    public void SetLimits(QuotaEntity limit) throws IOException {
