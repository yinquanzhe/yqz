package net.ahwater.ahwaterCloud.web.aop;
...
/**
 * Created by TECHMAN on 2018/3/7.
 */
@Aspect
@Component
public class WebLogAspect {
    ...
    @Pointcut("execution(public * net.ahwater.ahwaterCloud..controller.*.*(..))")//两个..代表所有子目录，最后括号里的两个..代表所有参数
