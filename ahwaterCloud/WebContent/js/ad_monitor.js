app.controller('ad_monitorCtrl',['$scope','$http','$interval',function($scope,$http,$interval){
	$scope.getAdminMonitor=function(){
		console.log('开始获取')
		$http({
			method:'get',
			url:'/ahwaterCloud/ctr/listAllTenantNewMonitor',
