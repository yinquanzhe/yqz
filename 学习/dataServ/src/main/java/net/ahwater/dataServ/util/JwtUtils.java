...
public class JwtUtils{
     ...
     * 密钥
     */
    private final String SECRET = "DataServ";
    private final String CREATED_TAG = "created";
    @SuppressWarnings("FieldCanBeLocal")
    private final int EXPIRATION_HOUR = 6;
    ...
    private String generateToken(Map<String, Object> claims) {
        Date expirationDate = new Date(System.currentTimeMillis() + (long) EXPIRATION_HOUR * 60 * 60 * 1000); // 1小时
     ...
     * @return 是否有效
     */
    public Boolean validateToken(String token, UserBO user) {
