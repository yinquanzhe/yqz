...
Page({
  data: {
    longitude: 117.2882028929,
    latitude: 31.864942016,
    speed: 0,
    accuracy: 0,
    markers: [],
    polyline: [],
  ...
  onLoad: function () {
    ...
    qqmapsdk = new QQMapWX({
      key: 'K7YBZ-3VUK2-2INU3-CGDCJ-JFYWT-2UFPR'
    })
  },
  onShow() {
    var that = this
  ...
  guihua(e) {
    ...
    wx.request({
      url: `${url}?from=${loclat},${loclng}&to=${tolat},${tolng}&key=K7YBZ-3VUK2-2INU3-CGDCJ-JFYWT-2UFPR`,
      data: {},
