...
public class CoreRoleController {
     ...
     * @return
     */
    @RequestMapping(value="addPermission.do",method = {RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value="getPermission.json",method = {RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
