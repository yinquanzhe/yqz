...
@Api(description="描述",tags="用户相关控制器")
@Controller
...
//    @RequiresRoles("超级用户")
     ...
     * @return
     */
    @ApiOperation(value="进入新增页面", notes="进入新增页面")
     ...
     * @return
     */
    @ApiOperation(value="进入密码修改页面", notes="进入密码修改页面")
...
//        coreUser.setId(Integer.parseInt(uuid));
     ...
     * @return
     */
    @ApiOperation(value="编辑操作", notes="编辑操作")
     ...
     * @throws Exception
     */
    @ApiOperation(value="查询单条数据操作", notes="查询单条数据操作")
     ...
     * @return
     */
    @ApiOperation(value="查询全部数据操作", notes="查询全部数据操作")
    @RequestMapping(value="all.json",method = {RequestMethod.POST,RequestMethod.GET})
    @ResponseBody
     ...
     * @return
     */
    @ApiOperation(value="查询分页数据操作", notes="查询分页数据操作")
     ...
     * @return
     */
    @ApiOperation(value="修改用户密码操作", notes="修改用户密码操作")
